...
if "time_log" not in st.session_state:
    st.session_state.time_log = []  # ✅ store timestamps for graph
...
if not st.session_state.run and st.session_state.start_time and st.session_state.emotion_log:
    ...
    if st.button("📤 Generate PDF Report"):
        path = generate_pdf_report("session_summary.txt",
                                   "assets/emotion_pie.png",
                                   "assets/focus_pie.png",
